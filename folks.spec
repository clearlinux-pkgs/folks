...
%prep
%setup -q -n folks-0.14.0
cd %{_builddir}/folks-0.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619150869
...
cp %{_builddir}/folks-0.14.0/COPYING %{buildroot}/usr/share/package-licenses/folks/9a1929f4700d2407c70b507b3b2aaf6226a9543c
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/folks/46/backends/dummy/dummy.so
/usr/lib64/folks/46/backends/eds/eds.so
/usr/lib64/folks/46/backends/key-file/key-file.so
/usr/lib64/folks/46/backends/ofono/ofono.so
/usr/lib64/libfolks-dummy.so.25
/usr/lib64/libfolks-dummy.so.25.21.0
/usr/lib64/libfolks-eds.so.25
/usr/lib64/libfolks-eds.so.25.21.0
/usr/lib64/libfolks.so.25
/usr/lib64/libfolks.so.25.21.0
